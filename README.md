...
**🕹️ 真的会安排复习节奏**
不是刷完一遍就完事。基于 Leitner 间隔重复：答错埋到 5~7 题之后重来，答对则按 5 → 10 → 18 题的间隔逐步拉长，连续答对 4 次判定掌握并移出队列。低频打扰、高频巩固，把时间花在真正记不住的题上。
...
**📕 错题本会自己变薄**
错题按来源分类（闯关 / 速览 / 考试），加强练习连续答对 4 次自动移出，重新考试答对即移出。剩下的永远是真正没掌握的。
...
| | 模式 | 干什么用 | 关键机制 |
|---|---|---|---|
| 🕹️ | **记忆闯关** | 日常主刷 | Leitner 间隔重复，连续答对 4 次掌握 |
